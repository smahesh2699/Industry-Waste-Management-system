...
<div class="hero-wl">
    <div class="container text-center py-5">
        ...
        <div class="d-flex justify-content-center gap-3">
            <a href="login.jsp" class="btn btn-light btn-lg px-4 fs-6 fw-semibold text-success">Post Waste Listing</a>
            <a href="register.jsp?role=RECYCLER" class="btn btn-wl-primary btn-lg px-4 fs-6 fw-semibold text-white">Find Recyclables</a>
        </div>
    </div>
</div>
